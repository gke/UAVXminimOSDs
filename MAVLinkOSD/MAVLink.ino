...
void read_mavlink(){
  ...
  while(Serial.available() > 0) { 
    ...
    if (millis() < 20000 && millis() > 5000 && !mavlink_active) {
      if (c == '\n' || c == '\r')
        crlf_count++;
      else
        crlf_count = 0;
    ...
    if(mavlink_parse_char(MAVLINK_COMM_0, c, &msg, &status)) {
      ...
      case MAVLINK_MSG_ID_SYS_STATUS:
          osd_vbat_A = (mavlink_msg_sys_status_get_voltage_battery(&msg) * 0.001f); //Battery voltage, in millivolts (1 = 1 millivolt)
      ...
      case MAVLINK_MSG_ID_GPS_RAW_INT:
          osd_lat = mavlink_msg_gps_raw_int_get_lat(&msg) * 0.0000001f;
          osd_lon = mavlink_msg_gps_raw_int_get_lon(&msg) * 0.0000001f;
      ...
      case MAVLINK_MSG_ID_RC_CHANNELS_RAW:
          //                    chan_raw[1] = mavlink_msg_rc_channels_raw_get_chan1_raw(&msg);
          //                    chan_raw[2] = mavlink_msg_rc_channels_raw_get_chan2_raw(&msg);
          //                    chan_raw[3] = mavlink_msg_rc_channels_raw_get_chan3_raw(&msg);
          //                    chan_raw[4] = mavlink_msg_rc_channels_raw_get_chan4_raw(&msg);
